...
const EditorFrame = () => {
  ...
  const editorConnect = useCallback(() => {
    ...
    // stompClient.current = StompJs.client(CONNECTION_URL);
    stompClient.current.onConnect = () => {
      console.log('ccc', stompClient.current);
  ...
  useDidMountEffect(() => {
    console.log(isConnected, stompClient.current);

    if (stompClient.current.connected) handleEditorChange(editorData);
  }, [editorData]);
...
//   ElementControlWidget,
//   SectionControlWidget,
// } from '@components/Editor/ControlWidget';
